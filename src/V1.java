...
public class V1 {
    ...
    public Complex [][] FFT () {
        ...
        final int totalSize = (int) (audioBytes.length *0.2);
        int chunkSize = 4194304 ;
        int amountPossible = (int) (totalSize/chunkSize);
        ...
        for (int times = 0; times < amountPossible; times++) {
            ...
            results[times] = new FastFourierTransformer(DftNormalization.STANDARD).transform(complex, TransformType.FORWARD);
        }
        return results;
